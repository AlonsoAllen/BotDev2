...
const Autor = require("../../schemas/AutorSchema");
...
module.exports = class extends Command {
  constructor(client) {
    super(client, {
      name: "formulario_cadastro_autor",
  ...
  run = (interaction) => {
    interaction.reply({
      content: "Formulário de cadastro iniciado. Responda às perguntas abaixo:",
      ephemeral: true,
    });
      ...
      for (const question of questions) {
        ...
        if (question.options) {
          ...
          if (reason === "limit") {
            ...
            throw "O tempo para responder a pergunta se esgotou! Formulário cancelado.";
          else
            throw "Ocorreu um erro durante a realização do formulário e este foi finalizado.";
        } else {
          const msg = await channel.send({
            content: interaction.user.toString(),
            embeds: [embed],
